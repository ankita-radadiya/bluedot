...
export default async function decorate(block) {
  ...
  if (!checkIsAuthenticated()) {
    ...
    const setupTableStructure = () => {
      ...
      // Format any unformatted rows first so we get an accurate card count
      ...
      // If there are no order cards, remove any existing header and bail out
      if (!firstCard) {
      ...
      // Insert / reposition header directly before the first card
